...
import { addressIdentity, almIdentity, bankAccountIdentity, basicPhoneIdentity, bvnIdentity, cacIdentity, crcIdentity, creditPremuimIdentity, driverLicenceIdentity, ecosystemIdentity, firstCentralIdentity, karmaIdentity, ninIdentity, phoneIdentity, radarBvnIdentity, radarPhoneIdentity, votersCardIdentity } from '../controller/Identity/identity';
